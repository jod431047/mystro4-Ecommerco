...
class Product(models.Model):
    ...
    subtitle = models.TextField(_('subtitle'),max_length=600)            # brand = models.""
...
class Review(models.Model):
    user = models.ForeignKey(User,verbose_name=('user'),related_name='user_review',on_delete=models.SET_NULL,null=True,blank=True)
    product = models.ForeignKey(Product,verbose_name=('Product'),related_name='product_review',on_delete=models.SET_NULL,null=True,blank=True)
